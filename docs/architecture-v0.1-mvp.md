...
- Dashboard 活动日志为占位实现
- i18n 覆盖 auth/setup/settings/home/movies/nav 页面, 包括 Tab 导航标签 (homeTab/favoritesTab/noFavorites/favorites/noFavorites/selectLibrary)
