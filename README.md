...
> **Coming soon.** Docker image for Linux/NAS deployment (amd64 + arm64) is planned and will be published to GitHub Container Registry. This will support Synology, QNAP, Unraid, and any Linux server with Docker.
