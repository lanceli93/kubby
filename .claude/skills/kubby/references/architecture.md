...
- [Database Schema (31 tables)](#database-schema-31-tables)
...
│   │   ├── db/
│   │   │   ├── schema.ts                 # Drizzle schema (31 tables, incl. photo_items + photo_albums/photo_album_items + 6 music tables + 9 TV tables)
...
### TV domain tables (migration 0040)

Nine tables. Three-tier hierarchy; cast is isolated from cinema (`tv_people`, photos
